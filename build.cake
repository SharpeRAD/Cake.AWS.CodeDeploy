...
// Define directories.
var buildDir = "./src/CodeDeploy/bin/" + configuration;
var buildTestDir = "./src/CodeDeploy.Tests/bin/" + configuration;
...
// Package
var zipPackage = buildResultDir + "/Cake-AWS-CodeDeploy-v" + semVersion + ".zip";
...
{
    // Addin
    CopyFileToDirectory(buildDir + "/Cake.AWS.CodeDeploy.dll", binDir);
    CopyFileToDirectory(buildDir + "/Cake.AWS.CodeDeploy.pdb", binDir);
    CopyFileToDirectory(buildDir + "/Cake.AWS.CodeDeploy.xml", binDir);

    CopyFileToDirectory(buildDir + "/AWSSDK.Core.dll", binDir);
    CopyFileToDirectory(buildDir + "/AWSSDK.CodeDeploy.dll", binDir);
    ...
    // Test
    CreateDirectory("./test/tools/Addins/Cake.AWS.CodeDeploy/lib/net45/");

    CopyFileToDirectory(buildDir + "/Cake.AWS.CodeDeploy.dll", "./test/tools/Addins/Cake.AWS.CodeDeploy/lib/net45/");
    CopyFileToDirectory(buildDir + "/AWSSDK.Core.dll", "./test/tools/Addins/Cake.AWS.CodeDeploy/lib/net45/");
    CopyFileToDirectory(buildDir + "/AWSSDK.CodeDeploy.dll", "./test/tools/Addins/Cake.AWS.CodeDeploy/lib/net45/");
});
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.AWS.CodeDeploy.nuspec", new NuGetPackSettings
    {
        Version = version,
    ...
    .Does(() =>
{
    ...
    // Push the package.
    var package = nugetRoot + "/Cake.AWS.CodeDeploy." + version + ".nupkg";
